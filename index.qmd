...
Nach dem Herunterladen wurden die Daten mittels R und RStudio aufbereitet.
...
SwissBOUNDARIES3D von swisstopo lieferte SHP-Dateien für die Grenzen der untersuchten Gemeinde, die ins WGS84-System konvertiert wurden.
OpenStreetMap-Daten dienten als Kartenhintergrund in den Visualisierungen.
...
Weitere Auswertungen, in denen die Abhängigkeit der zurückgelegten Distanz von der Uhrzeit oder des Wochentages untersucht wurde, sind im Anhang zu finden.
...
Grafiken dazu sind im Anhang zu finden.
...
Denn die Genauigkeit von Google Maps Daten hängt massgeblich von der verwendeten Technologie, sowie weiteren Faktoren ab (Macarulla Rodriguez et al. 2018, Parady et al. 2023).
